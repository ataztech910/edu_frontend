...
export default function CourseItem(props: any) {
  return (
    <Link href={`/course/${props.id}`} className="hover:shadow-md">
        ...
        <div className="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-inherit m-2 normal-case">
